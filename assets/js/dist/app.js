...
`);
    ...
    compileShaders() {
      ...
      const vertexShaderSource = `#version 300 es
            ...
            void main() {
                ...
                // pow(x, 16) rozlo\u017Eeno na 4\xD7 n\xE1soben\xED \u2014 identick\xFD v\xFDsledek, rychlej\u0161\xED na GPU
  ...
  function getDeviceProfile() {
    ...
    console.info(
      `[DeviceProfile] tier=${tier} (${_cached.label}) | ${vw}\xD7${vh}px | cores=${cores} dpr=${dpr} conn=${connType || "unknown"} | budgetDprCap=${_cached.entityBudget.dprCap}`
    );
    return _cached;
  }
